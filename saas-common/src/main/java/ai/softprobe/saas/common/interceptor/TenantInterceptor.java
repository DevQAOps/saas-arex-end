...
import ai.softprobe.saas.common.model.Constants;
import ai.softprobe.saas.common.utils.ResponseWriterUtil;
...
public class TenantInterceptor extends AbstractInterceptorHandler {
  ...
  public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
    ...
    try {
      ...
      TenantLimitService.TenantLimitInfo tenantLimitInfo = TenantLimitService.TenantLimitInfo.builder().tenantCode(tenantCode).build();
      TenantLimitService.TenantLimitResult tenantLimitResult = limitTenant.limitTenant(tenantLimitInfo);
