package ai.softprobe.saas.api.service.impl.login;

import ai.softprobe.saas.api.service.OauthService;
import ai.softprobe.saas.api.model.dto.login.Oauth0CodeInfo;
import ai.softprobe.saas.api.model.dto.login.OauthInfoDto;
import ai.softprobe.saas.api.model.dto.login.OauthResult;
import ai.softprobe.saas.api.model.enums.OauthTypeEnum;
...
public class Oauth0ServiceImpl implements OauthService, InitializingBean {
  ...
  @Value("${sp.oauth.oauth0.rsaPrivateKey}")
