package ai.softprobe.saas.api.service.impl.clientlogin;

import ai.softprobe.saas.api.service.ClientOauthService;
import ai.softprobe.saas.api.service.http.HttpProxyFactory;
...
public class Oauth0ClientOauthServiceImpl implements ClientOauthService {
  ...
  @Value("${sp.oauth.oauth0.auth0IssuerBaseUrl}")
  ...
  public ClientOauthResultDto doOauth(ClientOauthInfoDto clientOauthInfoDto) {
    if (jwtVerifier == null) {
      throw new SpSaasException(ErrorCode.CLIENT_LOGIN_AUTH0_VERIFY_FAILED.getCodeValue(),
          "jwtVerifier is null");
    }
    ...
    try {
      ...
      throw new SpSaasException(ErrorCode.CLIENT_LOGIN_PROVIDER_NOT_SUPPORTED.getCodeValue(), e);
    }
